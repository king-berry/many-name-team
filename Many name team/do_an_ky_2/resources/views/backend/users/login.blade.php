                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="email"  name="user_email" class="form-control" placeholder="Nhập Email Ở Đây">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="password"  name="user_password" class="form-control" placeholder="Nhập Mật khẩu Ở Đây">
                        </div>
                      </div>
                    </div>
