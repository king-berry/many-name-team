...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <a href="admin/brands/create" class="btn btn-primary" data-color="green">Thêm BỘ SƯU TẬP Decor</a>
        </div>
        <div class="col-md-12">
            <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title ">BỘ SƯU TẬP Decor</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <table class="table">
                    <thead class="text-primary text-center">
                        <th style="width: 150px;">BỘ SƯU TẬP</th>
...
@section('script')
  <script>
      ...
      $('.button-delete').click(function (e) {
        ...
        swal({
            title: "Bạn có chắc sẽ xóa BỘ SƯU TẬP decor này",
            icon: "warning",
            buttons: true,
            dangerMode: true,
            })
