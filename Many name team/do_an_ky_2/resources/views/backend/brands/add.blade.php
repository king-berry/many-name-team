        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title">Thêm BỘ SƯU TẬP Decor</h4>
            </div>
            <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="bmd-label-floating">Tên BỘ SƯU TẬP Decor</label>
          ...
          <button type="submit" class="btn btn-primary pull-right">Thêm BỘ SƯU TẬP Decor</button>
