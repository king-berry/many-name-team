                    ...
                    <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                        <div class="ht__product__dtl">
                            ...
                            <ul  class="pro__prize">
                                ...
                                <li class="old__prize">{{number_format($data->product_price_sell)}} $</li>
                                <li>{{number_format($product_price_sale = $data->product_price_sell - ($data->product_price_sell/100 * $data->product_sale))}} $</li>
                            </ul>
                            <br>
                            <ul class="rating">
                            ...
                            <form>
                                ...
                                <div class="sin__desc align--left">
                                    <p><span>BỘ SƯU TẬP decor:</span></p>
                                    <ul class="pro__cat__list">
