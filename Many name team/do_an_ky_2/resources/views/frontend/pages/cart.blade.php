                                ...
                                <div class="htc__cart__total">
                                    ...
                                    <div class="cart__desk__list">
                                        ...
                                        <ul class="cart__price">
                                            <li id="cart_total">{{number_format($cart_total)}} $</li>
                                        </ul>
                                    </div>
                                    <div class="cart__total">
                                        <span>Tổng: </span>
                                        <span id="cart_totals">{{number_format($cart_totals)}} $</span>
                                    </div>
        ...
        $('#check_coupon_cart').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#cart_totals').text(data[2].toLocaleString('ja-JP')+ ''+ ' $')
                }
            })
        })
        ...
        $('.cart_delete').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#cart_total').text(data[0].toLocaleString('ja-JP')+ ''+ ' $');
                    $('#cart_totals').text(data[1].toLocaleString('ja-JP')+ ''+ ' $')
                }
            })
        })
        ...
        $('.get_qty').change(function() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#cart_total').text(data[1].toLocaleString('ja-JP')+ ''+ ' $');
                }
            })
        })
    </script>
