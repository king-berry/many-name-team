...
<head>
    ...
    @else
        <meta property="og:image" content="../libs/Fashion Lifestyle-logo.jpeg"/>
    @endif

    <link rel="shortcut icon" type="image/x-icon" href="../libs/logo-2.jpeg">
            ...
            <div class="footer__container bg__cat--1">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="footer">
                                ...
                                <div class="ft__details">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <p>Fashion Lifestyle luôn luôn mong muốn đem đến cho quý khách hàng những sản phẩm uy tín, chất lượng, giá cả tốt nhất thị trường</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12 xmt-40">
                            <div class="footer">
                                <h2 class="title__line--2">BỘ SƯU TẬP</h2>
                                <div class="ft__inner">
                                    <ul class="ft__list">
        ...
        $('.cart__menu').click(function(){
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(Array.isArray(data[0])){
                        ...
                        output +=`<div class="shp__single__product tr-${item['cart_id']}">
                                ...
                                <div class="shp__pro__details">
                                    ...
                                    <span class="shp__price">${formatter.format(item['cart_price_sale'])+ ' $'}</span>
                                </div>
                                <form>
                                @csrf
                    ...
                    $('.total__price').text(data[1].toLocaleString('ja-JP')+ ''+ ' $');
                    ...
                    $('.button_del').click(function () {
                        ...
                        $.ajax({
                            ...
                            success: function(dataDel){
                                $('.tr-'+id).remove();
                                $('.total__price').text(dataDel[0].toLocaleString('ja-JP')+ ''+ ' $');
                            }
                        })
                    })
                }
