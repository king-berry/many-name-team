...
class PageController extends Controller
{
    ...
    public function __construct(){
        ...
        $this->data_seo = new SeoHelper('Kính chào quý khách', ' Áo polo, Áo thun, Áo len ,Quần jeans ,Quần short ,Đồ lót', 'Fashion Lifestyle', 'http://127.0.0.1:8000/');
        view()->share([
    ...
    public function shop(){
        $this->data_seo = new SeoHelper('Cửa hàng',' Áo polo, Áo thun, Áo len ,Quần jeans ,Quần short ,Đồ lót', 'Fashion Lifestyle', 'http://127.0.0.1:8000/shop');
