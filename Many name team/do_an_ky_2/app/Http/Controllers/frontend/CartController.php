...
class CartController extends Controller
{
    ...
    public function __construct(CartService $cartService){
        ...
        $this->data_seo = new SeoHelper('Kính chào quý khách', ' Áo polo, Áo thun, Áo len ,Quần jeans ,Quần short ,Đồ lót', 'Fashion Lifestyle', 'http://127.0.0.1:8000/cart');
